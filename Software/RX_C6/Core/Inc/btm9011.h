...
/* BTM9011 SPI command bytes ---------------------------------------------------*/
/* Byte layout: [0, IN1, IN2, PWM4..PWM0]
 * IN1=1,IN2=0 → forward (PWM); IN1=0,IN2=1 → reverse (PWM); IN1=IN2=1 → coast */
#define BTM9011_CMD_BRAKE    0x00  /* IN1=0, IN2=0            */
#define BTM9011_CMD_FORWARD  0x59  /* IN1=1, IN2=0, PWM=25/31 */
#define BTM9011_CMD_REVERSE  0x39  /* IN1=0, IN2=1, PWM=25/31 */
#define BTM9011_CMD_COAST    0x60  /* IN1=1, IN2=1            */

...
HAL_StatusTypeDef BTM9011_Send(BTM9011_HandleTypeDef *hbtm, const uint8_t *cmds)
{
    ...
    HAL_GPIO_WritePin(hbtm->cs_port, hbtm->cs_pin, GPIO_PIN_SET);
    HAL_StatusTypeDef status = HAL_SPI_Transmit(hbtm->hspi, tx, hbtm->num_drivers, 100);
    HAL_GPIO_WritePin(hbtm->cs_port, hbtm->cs_pin, GPIO_PIN_RESET);
...
uint8_t BTM9011_BuildCmd(BTM9011_Dir dir, uint8_t duty_0_31)
{
    ...
    switch (dir)
    {
        case BTM9011_DIR_FORWARD: in1 = 1; in2 = 0; break;
        case BTM9011_DIR_REVERSE: in1 = 0; in2 = 1; break;
        case BTM9011_DIR_COAST:   in1 = 1; in2 = 1; break;

...
/* Private defines -----------------------------------------------------------*/
#define JOY_V_Pin GPIO_PIN_0
#define JOY_V_GPIO_Port GPIOA
#define JOY_H_Pin GPIO_PIN_1
#define JOY_H_GPIO_Port GPIOA
#define JOY_SEL_Pin GPIO_PIN_2
#define JOY_SEL_GPIO_Port GPIOA
#define RF_DATA_Pin GPIO_PIN_3
#define RF_DATA_GPIO_Port GPIOA
#define SW_R_Pin GPIO_PIN_0
#define SW_R_GPIO_Port GPIOB
#define SW_L_Pin GPIO_PIN_1
